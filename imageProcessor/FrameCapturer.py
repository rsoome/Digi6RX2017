...
class FrameCapturer:
    ...
    def capture(self, colorScheme):
        ...
        cv2.ellipse(self.filteredImg,(self.width//2, self.height), (self.width//3, self.height//5), 180, 180, 0, (255, 255, 255), -1)
        self.bw = cv2.cvtColor(self.capturedFrame, cv2.COLOR_BGR2GRAY)
        cv2.ellipse(self.bw, (self.width // 2, self.height), (self.width // 3, self.height//5), 180, 180, 0, (255, 255, 255), -1)
